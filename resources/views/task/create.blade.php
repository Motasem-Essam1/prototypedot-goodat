                ...
                <div class="services-header flex-center-v mb-3">
                    ...
                    <div class="breadcrumb-container">
                        <ol class="breadcrumb breadcrumb-list w-100">
                            ...
                            <li class="breadcrumb-item active max-1-line" aria-current="page">Add new Task</li>
                        </ol>
                    </div>
                    <!-- Breadcrumb -->
                        ...
                        <div class="ser-steps-container">
                            <form action="{{ route('task.add') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div data-step="step1" class="step-container step-info" >
                                    <div class="sc mb-5">
                                        <div class="step-main-title title text-uppercase">ADD A NEW TASK</div>
                                        <div class="step-sub-title">Add your task information</div>
                                    </div>
                                    ...
                                    <div class="sc-form">
                                        <div class="sc-double sc-double-text flex-between-h mb-4">
                                            <div class="form-group-row">
                                                ...
                                                <input class="fgr-input info-input" type="text" name="task_name" placeholder="Your task name" value="{{ old('task_name') }}" />
                                                <p style="color: red">
                                        ...
                                        <div class="sc-single mb-4">
                                            <div class="form-group-row">
                                                ...
                                                <textarea class="fgr-input info-input fgr-textarea" name="task_description" placeholder="Write Your Task Description">{{ old('task_description') }}</textarea>
                                            </div>
                                            <p style="color: red">
                                        ...
                                        <div class="sc-double flex-between-vh mb-4">
                                            <div class="form-group-row mb-3">
                                                ...
                                                <input class="fgr-input info-input only-numbers" type="text" name="starting_price" placeholder="FROM" value="{{ old('starting_price') }}" />
                                                <p style="color: red">
                                            ...
                                            <div class="form-group-row mb-3">
                                                ...
                                                <input class="fgr-input info-input only-numbers" type="text" name="ending_price" placeholder="TO" value="{{ old('ending_price') }}" />
                                                <p style="color: red">
                                ...
                                <div data-step="step2" class="step-container step-pictures" >
                                    <div class="sc mb-5 pb-2">
                                        <div class="step-main-title title text-uppercase">ADD A NEW TASK</div>
                                        <div class="step-sub-title">Add your task pictures</div>
                                    </div>
                                ...
                                <div data-step="step3" class="step-container step-location" >
                                    <div class="sc mb-5">
                                        <div class="step-main-title title text-uppercase">ADD A NEW TASK</div>
                                        <div class="step-sub-title">Add where your task will be done.</div>
                                    </div>
                                        ...
                                        <div class="sc-places">
                                            ...
                                            <div class="places-search position-relative flex-between-vh mb-4">
                                                <div id="searchGroup" class="access-close ps-input width-fluid flex-center-v mr-3">
                                                    ...
                                                    <div id="searchDropdown" class="access-close main-search-dropdown mt-1">
                                                        <div id="places-search" class="search-dropdown-content scroller">
                                                            {{--                                                        <div class="search-item close-dd-btn"><div class="search-item-url">Cairo, Nasr city</div></div>--}}
                                                        </div>
                                                ...
                                                <button type="button" class="btn btn-gray geo-location" id="getLocation">
                                                    <span class="icon-current-location icon mr-2"></span> <span class="get-loc-span">Get Location</span>
                                                </button>
                                            </div>
                                        </div>
...
@section('custom-script')
    ...
    <!-- Google Maps -->
{{--    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAn_HgrPw1nlEQr3tyYsdAL0yfbbRIGeGc&callback=initMap&v=weekly" defer></script>--}}
