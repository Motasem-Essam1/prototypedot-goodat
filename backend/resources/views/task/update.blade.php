@extends('layouts.app')
@section('title', 'Edit ' . $task->task_name)
@section('main-style')
    <!-- Toast -->
                ...
                <div class="services-header flex-center-v mb-3">
                    ...
                    <div class="breadcrumb-container">
                        <ol class="breadcrumb breadcrumb-list w-100">
                            ...
                            <li class="breadcrumb-item active max-1-line" aria-current="page">Edit Task</li>
                        </ol>
                    </div>
                    <!-- Breadcrumb -->
                    <!-- Appear In Responsive Only -->
                    <div class="ns-title cos-title sht-res"><span>Task.</span></div>
                </div>
                ...
                <div class="services-content">
                    ...
                    <div id="demo" class="services-flexable d-flex">
                        <div class="ser-steps text-center flex-center-vh">
                            <div class="steps-cards">
                                ...
                                <button data-step-target="step3" class="step-card-btn">
                                    <div class="step-logo flex-center-vh"><span class="icon-location-3 icon"></span></div>
                                    <div class="step-center-line"></div>
                        ...
                        <div class="ser-steps-container">
                            <form action="{{ route('update.task.data')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <input hidden class="fgr-input info-input" type="text" name="id" placeholder="Your task name" value="{{$task->id}}" />

                                <!-- Information -->
                                <div data-step="step1" class="step-container step-info" >
                                    <div class="sc mb-5">
                                        <div class="step-main-title title">EDIT | {{ $task['task_name'] }}</div>
                                        <div class="step-sub-title">Edit your task information</div>
                                    </div>

                                    <div class="sc-form">
                                        <div class="sc-double sc-double-text flex-between-h mb-4">
                                            <div class="form-group-row">
                                                <label class="fgr-label">Task Name</label>
                                                <input class="fgr-input info-input" type="text" name="task_name" placeholder="Your task name" value="{{ $task->task_name }}" />
                                                <p style="color: red">
                                            ...
                                            <div class="form-group-row">
                                                <label class="fgr-label">Task Category</label>
                                                <select class="sc-selectbox info-input text-capitalize" name="category_id" id="category">
                                                    @foreach($categories as $category)
                                                        <optgroup label="{{$category->category_name}}">
                                                            @foreach($category->subCategories as $subCategory)
                                                                @if($task->category_id == $subCategory->id)
                                        ...
                                        <div class="sc-single mb-4">
                                            <div class="form-group-row">
                                                <label class="fgr-label">Task Description</label>
                                                <textarea class="fgr-input info-input fgr-textarea" name="task_description" placeholder="Write Your Task Description">{{$task->task_description}}</textarea>
                                            </div>
                                            <p style="color: red">
                                        ...
                                        <div class="sc-double flex-between-vh mb-4">
                                            <div class="form-group-row mb-3">
                                                ...
                                                <input class="fgr-input info-input only-numbers" type="text" name="starting_price" placeholder="FROM" value="{{$task->starting_price}}" />
                                                <p style="color: red">
                                            ...
                                            <div class="form-group-row mb-3">
                                                ...
                                                <input class="fgr-input info-input only-numbers" type="text" name="ending_price" placeholder="TO" value="{{$task->ending_price}}" />
                                                <p style="color: red">
                                ...
                                <div data-step="step2" class="step-container step-pictures" >
                                    <div class="sc mb-5 pb-2">
                                        <div class="step-main-title title">EDIT | {{ $task['task_name'] }}</div>
                                        <div class="step-sub-title">Edit your task pictures</div>
                                    </div>
                                    ...
                                    <div class="sc-form">
                                        ...
                                        <div class="sc-main-img mb-4">
                                            ...
                                            <div class="sc-img-card d-inline-block">
                                                <div class="sc-img sc-img-bg inputfr-parent">
                                                    @if(isset($task->images[0]))
                                                        <div class="image-view imgfr-parent active">
                                                            <div id="loader-{{ $task->images[0]->id }}" class="imgfr-loader">
                                                                <img class="img-fluid" src="{{ asset('assets/img/icons/rolling.svg') }}" />
                                                            </div>
                                                            <img class="img-fluid img-view-src img-file-reader" src="{{ asset($task->images[0]->image_path) }}" />
                                                            <button data-image-id="{{ $task->images[0]->id }}" data-image-type="task" data-item-id="{{ $task->id }}" type="button" class="btn delete-img-btn">
                                                                <i class="fa-solid fa-trash icon"></i> Delete
                                                            </button>
                                                            <button type="button" class="btn close-img-reader unactive"><span class="icon-cancel icon"></span></button>
                                                        </div>
                                                    @else
                                                        <div class="image-view imgfr-parent">
                                                            <img class="img-fluid img-view-src img-file-reader" src="" alt=""/>
                                                            <button type="button" class="btn close-img-reader"><span class="icon-cancel icon"></span></button>
                                                        </div>
                                                    @endif
                                                    ...
                                                    <input class="input-file-reader" name="images[]" type="file" accept="image/*" />
                                                </div>
                                                <p style="color: red">
                                                ...
                                                @for ($i = 0; $i < 4; $i++)
                                                    ...
                                                    <div class="other-img-card d-inline-block">
                                                        <div class="sc-img sc-img-sm inputfr-parent">
                                                            @if(count($task->images) > $index)
                                                                <div class="image-view imgfr-parent active">
                                                                    <div id="loader-{{ $task->images[$index]->id }}" class="imgfr-loader">
                                                                        <img class="img-fluid" src="{{ asset('assets/img/icons/rolling.svg') }}" />
                                                                    </div>
                                                                    <img class="img-fluid img-view-src img-file-reader" src="{{ asset($task->images[$index]->image_path) }}" alt=""/>
                                                                    <button data-image-id="{{ $task->images[$index]->id }}" data-image-type="task" data-item-id="{{ $task->id }}" type="button" class="btn delete-img-btn"><i class="fa-solid fa-trash icon"></i> Delete</button>
                                                                    <button type="button" class="btn close-img-reader unactive"><span class="icon-cancel icon"></span></button>
                                                                </div>
                                                            @else
                                                                <div class="image-view imgfr-parent">
                                        ...
                                        <div class="sc-alert flex-center-v pt-2 pb-4">
                                            ...
                                            If you have a picture to clear the task for the provider please include it.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div data-step="step3" class="step-container step-location" >
                                    <div class="sc mb-5">
                                        <div class="step-main-title title">EDIT | {{ $task['task_name'] }}</div>
                                        <div class="step-sub-title">Edit where your task will be done.</div>
                                    </div>

                                    <div class="sc-location">
                                        <div class="sc-places">
                                            <div class="sc-img-main-title mb-2">Task Location</div>
                                            <div class="places-search position-relative flex-between-vh mb-4">
                                                <div id="searchGroup" class="access-close ps-input width-fluid flex-center-v mr-3">
                                                    <span class="icon-search icon mr-2"></span>
                                                    <input id="pac-input" placeholder="Search Location" type="text" />
                                                    <div id="searchDropdown" class="access-close main-search-dropdown mt-1">
                                                        <div id="places-search" class="search-dropdown-content scroller">
                                                            <!-- Data Here --></div>
                                                        <div class="search-results text-left">Search results <span id="search-result"></span></div>
                                                    </div>
                                                </div>
                                                ...
                                                <button type="button" class="btn btn-gray geo-location" id="getLocation">
                                                    <span class="icon-current-location icon mr-2"></span>
                                                    <span class="get-loc-span">Get Location</span>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="map-container">
                                            ...
                                            <button id="toggleMapStyle" type="button" class="btn btn-toggle-style" data-style="dark">
                                ...
                                <!-- Steps Actions Btns -->
                                <div class="steps-actions d-inline-flex pt-3">
                                    <button data-step-action="next" class="btn step-btn btn-bg mr-4">Continue</button>
                                    <button type="submit" class="btn step-btn btn-bg mr-4">Submit Task</button>
...
@section('custom-script')
    ...
    <!-- Google Maps -->
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBtwuPEM2cVeJ6U5AIrVYhE-uTVGR7S0oo&libraries=places&callback=initMap"></script>
    ...
    <script>
        ...
        function mainLatLng(locationLat = "{{ $task->location_lat }}", locationLng = "{{ $task->location_lng }}") {
        ...
        function showPosition(position) {
            ...
            mainLocation['lat'] = parseFloat(posLat);
            mainLocation['lng'] = parseFloat(posLng);
            initMap();
        }
            ...
            function currentLocation() {
                navigator.geolocation.getCurrentPosition(
                    position => {
                        ...
                        mainLatLng(parseFloat("{{ $task->location_lat }}"), parseFloat("{{ $task->location_lng }}"));
                        initMap();
                    },
                    () => {
                    }
